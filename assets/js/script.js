...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Zidan Zakaria A";
...
var typed = new Typed(".typing-text", {
    strings: ["Automation Engineer", "IoT Engineer", "Robotic Engineer", "Electrical Engineer", "MRO Engineer"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
(function () {
    ...
    s1.async = true;
    s1.src = 'https://embed.tawk.to/673b1bf92480f5b4f59fd25f/1icveaicc';
    s1.charset = 'UTF-8';
